// Taken from https://github.com/MTG/essentia.js/tree/master/examples/offline/pitchmelodia
let essentia
let audioURL = '/essentiajs/Summertime15-voice.mp3'
...
async function onClickFeatureExtractor() {
  ...
  console.log('PITCHES')
  console.log(JSON.stringify(Array(...pitches)))
...
$(document).ready(function () {
  ...
  plotMelodyContour = new EssentiaPlot.PlotMelodyContour(
    Plotly,
    plotContainerId
  )
